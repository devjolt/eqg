...
g_nuclear_physics = [ 
    ...
    path('nuclear_physics_printable_B_question/', g_nuclear_physics_views.random_printable_B_question, name='random_printable_B_question'),
    path('nuclear_physics_printable_A_section/', g_nuclear_physics_views.random_printable_A_section, name='random_printable_A_section'),
    path('nuclear_physics_printable_B_section/', g_nuclear_physics_views.random_printable_B_section, name='random_printable_B_section'),
    path('nuclear_physics_interactive_A_question/', g_nuclear_physics_views.random_interactive_A_question, name='random_interactive_A_question'),
    path('nuclear_physics_interactive_B_question/', g_nuclear_physics_views.random_interactive_B_question, name='random_interactive_B_question'),
