...
class Question(eqg.UniversalQuestion):
    ...
    pair1a, pair1b, pair2a, pair2b, pair3a, pair3b = None, None, None, None, None, None
    pair4a, pair4b, pair5a, pair5b, pair6a, pair6b = None, None, None, None, None, None
    pair7a, pair7b, pair8a, pair8b, pair9a, pair9b = None, None, None, None, None, None
    pair10a, pair10b, pair11a, pair11b, pair12a, pair12b = None, None, None, None, None, None 
    options = None
    ...
    def __init__(self, function_name, correct = None, incorrect = None, marks = 1, correctRequired = 1, numOptions = 4, qtype = 'rand'):
        ...
        - function name AND correct answer to get a simple base question
        - include incorrect list for automatic generation of multi choice with 3 incorrect and one correct answer 
    ...
    def set_marks_and_level(self):#using last characted of func name, which should always be an integer
...
def url_name_list_from(module_list):
    url_name_list = []
    for item in module_list:
        url = item
        name = re.sub('_',' ',item[5:-5])#make name
        url_name_list.append({'url':url, 'name':name})
