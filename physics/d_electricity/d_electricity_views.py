...
def random_printable_A_section(request):
    ...
    while total_marks < target_marks:
        module_string = eligible[randint(0, len(eligible)-1)]
        print('module string', module_string)
        context = module_shortcut(module_string)
