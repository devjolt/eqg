...
core_1_220_1001_patterns = [
    ...
    path('random_mobile_devices/', aa_mobile_devices_views.aa_mobile_devices_random, name = 'aa_mobile_devices_random'),
    path('random_networking_technology/', ab_networking_technology_views.ab_networking_technology_random, name = 'b_networking_technology_random'),
